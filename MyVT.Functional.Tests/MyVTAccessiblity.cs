...
namespace Facebook.FunctionalTests
{
    public class AccessiblityTest
    {
        ...
        public void TestLogin()
        {
            ...
            //Click on Accessiblity Page and ensure it's displayed correctly 
            Thread.Sleep(2000);
            var input6 = WebDriver.FindElement(By.CssSelector("body > footer > div > div > div.govuk-footer__meta-item.govuk-footer__meta-item--grow > ul > li:nth-child(1) > a"));
            input6.Click();
            Thread.Sleep(2000);
            Assert.That(WebDriver.Title, Is.EqualTo("Accessibility statement"));
